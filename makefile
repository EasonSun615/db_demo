...
.PHONY:debug
debug:
	g++ -o db_demo_debug main.cpp InputBuffer.cpp MetaCommand.cpp Row.cpp Statement.cpp Table.cpp Pager.cpp Cursor.cpp LeafNode.cpp Node.cpp InternalNode.cpp -g
